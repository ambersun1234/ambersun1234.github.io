...
```shell
$ gpg --export --armor 7C4FA560330319BC5404972D7AD157320911F131 > gpg-public-key
```
...
$ gpg --keyserver hkps://keyserver.ubuntu.com --recv-keys 7C4FA560330319BC5404972D7AD157320911F131
```

> 其中 `7C4FA560330319BC5404972D7AD157320911F131` 為 signature key id，你可以用 `$ gpg --card-status` 來取得
...
gpg:                using RSA key 7C4FA560330319BC5404972D7AD157320911F131
gpg: Good signature from "Shawn Hsu <ambersun1019.shawn@gmail.com>" [ultimate]
```
> 如果把金鑰拔掉，就無法正確進行簽名
...
$ git config --global user.signingkey 7C4FA560330319BC5404972D7AD157320911F131
```
其中 `7C4FA560330319BC5404972D7AD157320911F131` 為你的 GPG fingerprint\
...
```shell
$ gpg --edit-key 7C4FA560330319BC5404972D7AD157320911F131
gpg> adduid
# 然後輸入姓名，email, 註解, 密碼
...
```shell
$ gpg --export --armor 7C4FA560330319BC5404972D7AD157320911F131
```
其中 7C4FA560330319BC5404972D7AD157320911F131 是 GPG 公鑰的 fingerprint\
然後把公鑰更新到 GitHub 上
