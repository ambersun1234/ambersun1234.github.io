...
categories: [database]
tags: [distributed, cluster, message queue, publisher, consumer, producer, subscriber, event, kafka, amqp, mqtt, jms, rabbitmq, dlq, pubsub, p2p, pull protocol, push protocol, consumer group, rebalancing, static membership]
math: true
---
